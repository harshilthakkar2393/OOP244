...
namespace sdds
{
    ...
    // copy constructor
    Vehicle::Vehicle(const Vehicle &rightHand)
    {
    ...
    Vehicle &Vehicle::operator=(const Vehicle &rightHand)
    {
    ...
    bool Vehicle::operator==(const char *liscensePlate) const
    {
        ...
        {
           proxyplate[i]= toupper(liscensePlate[i]);
        }
        proxyplate[strlen(liscensePlate)]=0;
        return(strcmp(proxyplate,this->numberPlate)==0);
    }
